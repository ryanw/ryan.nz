...
describe('Matrix4', () => {
  ...
  it('creates a rotation', () => {
    const rotation = Matrix4.rotation([0, 45 * DEGREE, 0] as Vector3).toArray();
  ...
  it('rotates a point', () => {
    const point: Point3 = [4, 5, 6];
    const rotation = Matrix4.rotation([0, 45 * DEGREE, 0] as Vector3);
